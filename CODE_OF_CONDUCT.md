...
* Publicar informações privadas de outros, como endereço físico ou de email,
...
estejam alinhadas a este Código de Conduta, e comunicarão as razões para as decisões
...
Exemplos de representar nossa comunidade incluem usar um endereço de email oficial,
postar através de uma conta oficial de mídia social, ou atuar como um representante
...
aqueles que fazem cumprir o Código de Conduta, por um período especificado de tempo. Isso
inclui evitar interações em espaços da comunidade, bem como canais externos
como mídia social. Violar estes termos pode levar a um banimento temporário ou
permanente.
...
pública com a comunidade por um período especificado de tempo. Nenhuma interação
...
As Diretrizes de Impacto na Comunidade foram inspiradas pela [escada de aplicação
